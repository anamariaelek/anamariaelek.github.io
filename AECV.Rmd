...
output:
  vitae::markdowncv: 
    theme: kjhealy
position: 
address: Comparative genomics and gene regulation.  
phone: ""
editor_options: 
  markdown: 
    wrap: 72
...
`r fa(name = "map-marker-alt", fill = "steelblue")` Carrer del Bruc 107,
08009 Barcelona, Spain

`r fa(name = "phone", fill = "steelblue")` +34 671 743 750

`r fa(name = "envelope", fill = "steelblue")`
[anamariaelek\@gmail.com](mailto:anamariaelek@gmail.com){.email}
...
tribble(
  ...
  c("Comparative regulatory genomics group (Sebé-Pedrós lab)", 
    ""),
  "London, UK", "Bioinformatician", "2019", "The Institute of Cancer Research", 
  c("Tumor Profiling Unit (Nik Matthews)")
) %>% 
...
orcid_token <- "ac3112e3-5701-4017-9cb4-9b4a265d540d"
...
tribble(
  ...
  c("In the organization of the summer school, I worked on program and participants selection.",
    "I was teaching two webinars (on R programming and single cell RNA-seq)",
    "and mentoring a hackathon team of 10 people (working on RNA-seq analysis project).",
    "I also led the project of developing an NGSchool website (https://ngschool.eu/)."),
  "2021", "Introduction to Machine Learning", "CRG Internal Training Course", "educational", 
  c("I gave a lecture and a workshop on feature selection and dimensionality reduction.")
