...
tribble(
  ...
  "Barcelona, ES", "PhD Student", "2019 - present", "Centre for Genomic Regulation", 
...
bibliography_entries("orcid.bib") %>%
  ...
  dplyr::slice(c(3,1,2,4)) # arrange manually
...
tribble(
  ...
  "2020 - present", "NGSchool", "bioinformatics summer school", "educational", 
